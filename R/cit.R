# =============================================================================
# R/cit.R -- Conditional independence test building blocks.
#
# Internal implementations of the CIT statistics (PCM, GCM, WGSC, KCI, ...)
# used by the wrappers in R/hypothesis_tests.R. The wrappers compose these
# with Algorithm 1 subsampling. Experiment scripts should call the wrappers,
# not the helpers in this file.
# =============================================================================
...
pcm_test_binary <- function(Y, X, Z, reg_method, binary_reg_method,
    ...
    # vtilde estimation (Bernoulli variance, matching Lundborg et al. 2024)
