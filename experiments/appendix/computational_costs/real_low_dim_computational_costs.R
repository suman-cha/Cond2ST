...
tag <- "real_low_dim_computational_costs"
...
reg_methods <- list(
    ...
    # "gam"    = list(regr.method = "gam_reg_method",    binary.regr.method = "gam_reg_method_binary")
)
...
filename <- paste0("results/ablations/simulation_results_", tag, ".csv")
